              ...
              <div className="home-slider-track blaze-track">
                ...
                <div data-role="current-banner" className="home-slide07 banner">
                  <span className="home-text129">
                    ...
                    <span className="home-text131">Juliana Davis</span>
                    <br className="home-text132"></br>
                    <span className="home-text133">&apos;Drinking Alone</span>
                ...
                <div data-role="current-banner" className="home-slide08 banner">
                  <span className="home-text140">
                    ...
                    <span className="home-text142">Freddie Dickson</span>
                    ...
                    <span className="home-text148">Recording Engineer</span>
                    <br className="home-text149"></br>
                    <span className="home-text150">Mix Engineer</span>
                    <br className="home-text151"></br>
                    <span className="home-text152">Producer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide09 banner">
                  <span className="home-text155">
                    ...
                    <span className="home-text157">MEMA.</span>
                    <br className="home-text158"></br>
                    <span className="home-text159">&apos;Leve Escuro</span>
                    <span className="home-text160">&apos;</span>
                    <br className="home-text161"></br>
                    <span className="home-text162">Album</span>
                ...
                <div data-role="current-banner" className="home-slide10 banner">
                  ...
                  <span className="home-text168">
                    ...
                    <span className="home-text170">Unknown Brain ft.</span>
                    <br className="home-text171"></br>
                    <span className="home-text172">Luke Burr</span>
                    ...
                    <span className="home-text177">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
                <div data-role="current-banner" className="home-slide11 banner">
                  <span className="home-text180">
                    ...
                    <span className="home-text182">MEMA.</span>
                    <br className="home-text183"></br>
                    <span className="home-text184">&apos;Estou Bem&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide12 banner">
                  <span className="home-text190">
                    ...
                    <span className="home-text192">Jubilee ft. IQ</span>
                    ...
                    <span className="home-text197">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide13 banner">
                  ...
                  <span className="home-text200">
                    ...
                    <span className="home-text202">Sandunes</span>
                    ...
                    <span className="home-text207">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
              ...
              <div className="home-slider-track1 blaze-track">
                <div data-role="current-banner" className="home-slide14 banner">
                  <span className="home-text210">
                    ...
                    <span className="home-text212">Vivi Thill</span>
                    ...
                    <span className="home-text216">of a songwriter&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide15 banner">
                  ...
                  <span className="home-text222">
                    ...
                    <span className="home-text224">Kota Banks</span>
                ...
                <div data-role="current-banner" className="home-slide17 banner">
                  <span className="home-text242"></span>
                  <img
                    alt="image"
                    src="https://freight.cargo.site/w/600/q/75/i/01d4d8ebb25c394ba53de81eef6ff759c150f1c801ebf8df5f677f7d1be4ae6a/fullacurve.jpg"
                ...
                <div data-role="current-banner" className="home-slide18 banner">
                  ...
                  <span className="home-text243">
                    ...
                    <span className="home-text245">Sandunes</span>
                    ...
                    <span className="home-text250">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
    ...
    transitionDuration: 0,
        ...
        <div className="home-container09">
          <div className="home-container10">
            ...
            <h1 className="home-heading2">
              <span className="home-text253">LISTEN</span>
              <br></br>
            </h1>
          </div>
        </div>
          ...
          <div id="whatido" className="home-container15">
            <div className="home-container16">
              ...
              <h1 className="home-heading3">
                <span className="home-text256">WHAT I DO</span>
          ...
          <div className="home-container18">
            <div className="home-container19">
              <span className="home-text258">
                <span className="home-text259">RECORDING</span>
                <br className="home-text260"></br>
                <span className="home-text261"> Vocal Tracking</span>
                <br className="home-text262"></br>
                <span className="home-text263"> Full band tracking</span>
                <br className="home-text264"></br>
                <span className="home-text265"> Live Sessions</span>
                <br className="home-text266"></br>
                <span className="home-text267">
                   Podcast, Voiceover &amp; Radio IDs
                </span>
                <br className="home-text268"></br>
                <span className="home-text269"> Broadcast for livestream</span>
                <br className="home-text270"></br>
                <br className="home-text271"></br>
                <span className="home-text272">SOFTWARE I USE</span>
                <br className="home-text273"></br>
                <span className="home-text274"> Pro Tools HD</span>
                <br className="home-text275"></br>
                <span className="home-text276"> Logic Pro X</span>
                <br className="home-text277"></br>
                <span className="home-text278"> </span>
                <span className="home-text279">UAD Console</span>
                <br className="home-text280"></br>
                <span className="home-text281"> Izotope RX</span>
                <br className="home-text282"></br>
                <span className="home-text283"> Fab Filter Pro</span>
                ...
                <span className="home-text287"> + more</span>
                <br className="home-text288"></br>
                <br className="home-text289"></br>
                <span className="home-text290">HARDWARE I USE</span>
                <br className="home-text291"></br>
                <span className="home-text292"> SSL4000G Series</span>
                <br className="home-text293"></br>
                <span className="home-text294"> SSL AWS 948</span>
                ...
                <span className="home-text306"> Ferrofish Converters</span>
                ...
                <span className="home-text310"> + more</span>
                <br className="home-text311"></br>
              </span>
            </div>
            <span className="home-text312">
              <span className="home-text313">MIXING</span>
              ...
              <span className="home-text319"> Vocal Tuning with Melodyne</span>
              <br className="home-text320"></br>
              <span className="home-text321">
                 Vocalign
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
              ...
              <span className="home-text323"> Drum Editing</span>
              <br className="home-text324"></br>
              <span className="home-text325"> Podcast</span>
              <br className="home-text326"></br>
              <br className="home-text327"></br>
              <br className="home-text328"></br>
              <span className="home-text329">STUDIOS IVE WORKED FOR</span>
              ...
              <span className="home-text335"> Strongroom Studios London</span>
              <br className="home-text336"></br>
              <span className="home-text337"> Noatune Studios London</span>
              <br className="home-text338"></br>
              <br className="home-text339"></br>
              <span className="home-text340">AWARDS</span>
              ...
              <span className="home-text349">MASTERCLASSES</span>
              <br className="home-text350"></br>
              <span className="home-text351"> P</span>
        ...
        <div className="home-container20">
          <div className="home-container21">
            ...
            <h1 className="home-heading4">
              <span className="home-text354">WHAT I DO</span>
      ...
      <div className="home-blog">
        <h1 id="blog" className="home-heading5">
          ...
          <span className="home-text357">&gt;</span>
          <span className="home-text358">BLOG</span>
          <br></br>
        </h1>
      </div>
        ...
        <div className="home-content">
          <div className="home-container27">
            <span className="home-text360">
              <span className="home-text361">  RUBY SMITH</span>
              <br></br>
            ...
            <span className="home-text369">
              <span className="home-text370">For all enquiries:</span>
              <span>
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
      ...
      <div className="home-footer">
        <div className="home-content1">
          <div className="home-bottom">
            ...
            >
              <img alt="image" src="/arrow.svg" className="home-image22" />
            </a>
          </div>
        </div>
      </div>
