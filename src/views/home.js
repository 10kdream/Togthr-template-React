        ...
        <div className="home-container09">
          <div className="home-container10">
            ...
            <h1 className="home-heading2">
              <span className="home-text101">LISTEN</span>
              <br></br>
            </h1>
          </div>
        </div>
          ...
          <div id="whatido" className="home-container15">
            <div className="home-container16">
              ...
              <h1 className="home-heading3">
                <span className="home-text104">WHAT I DO</span>
          ...
          <div className="home-container18">
            <div className="home-container19">
              <span className="home-text106">
                <span className="home-text107">RECORDING</span>
                <br className="home-text108"></br>
                <span className="home-text109"> Vocal Tracking</span>
                <br className="home-text110"></br>
                <span className="home-text111"> Full band tracking</span>
                <br className="home-text112"></br>
                <span className="home-text113"> Live Sessions</span>
                <br className="home-text114"></br>
                <span className="home-text115">
                   Podcast, Voiceover &amp; Radio IDs
                </span>
                <br className="home-text116"></br>
                <span className="home-text117"> Broadcast for livestream</span>
                <br className="home-text118"></br>
                <br className="home-text119"></br>
                <span className="home-text120">SOFTWARE I USE</span>
                <br className="home-text121"></br>
                <span className="home-text122"> Pro Tools HD</span>
                <br className="home-text123"></br>
                <span className="home-text124"> Logic Pro X</span>
                <br className="home-text125"></br>
                <span className="home-text126"> Izotope RX</span>
                <br className="home-text127"></br>
                <span className="home-text128"> Fab Filter Pro</span>
                <br className="home-text129"></br>
                <span className="home-text130"> UAD Console</span>
                <br className="home-text131"></br>
                <span className="home-text132"> Soundtoys</span>
                <br className="home-text133"></br>
                <br className="home-text134"></br>
                <span className="home-text135">HARDWARE I USE</span>
                <br className="home-text136"></br>
                <span className="home-text137"> SSL4000G Series</span>
                <br className="home-text138"></br>
                <span className="home-text139"> SSL AWS</span>
                ...
                <span className="home-text149"> Ferrofish Converters</span>
                <br className="home-text150"></br>
                <span className="home-text151"> Antelope Orion Converters</span>
                <br className="home-text152"></br>
              </span>
            </div>
            <span className="home-text153">
              <span className="home-text154">MIXING</span>
              ...
              <span className="home-text160"> Pro Tools HD</span>
              <br className="home-text161"></br>
              <span className="home-text162"> Logic Pro X</span>
              <br className="home-text163"></br>
              <br className="home-text164"></br>
              <br className="home-text165"></br>
              <span className="home-text166">STUDIOS IVE WORKED FOR</span>
              ...
              <span className="home-text172"> Strongroom Studios London</span>
              <br className="home-text173"></br>
              <span className="home-text174"> Noatune Studios London</span>
              <br className="home-text175"></br>
              <br className="home-text176"></br>
              <span className="home-text177">AWARDS</span>
              ...
              <span className="home-text186">MASTERCLASSES</span>
              <br className="home-text187"></br>
              <span className="home-text188"> P</span>
