              ...
              <div className="home-slider-track blaze-track">
                ...
                <div data-role="current-banner" className="home-slide07 banner">
                  <span className="home-text129">
                    ...
                    <span className="home-text131">Jade Empress</span>
                    <br className="home-text132"></br>
                    <span className="home-text133">&apos;Golden Hours</span>
                    <span className="home-text134">&apos;</span>
                    <br className="home-text135"></br>
                    <br className="home-text136"></br>
                    <span className="home-text137">Mix Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide08 banner">
                  <span className="home-text140">
                    ...
                    <span className="home-text142">Juliana Davis</span>
                    <br className="home-text143"></br>
                    <span className="home-text144">&apos;Drinking Alone</span>
                    <span className="home-text145">&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide09 banner">
                  <span className="home-text151">
                    ...
                    <span className="home-text153">Freddie Dickson</span>
                    ...
                    <span className="home-text159">Recording Engineer</span>
                    <br className="home-text160"></br>
                    <span className="home-text161">Mix Engineer</span>
                    <br className="home-text162"></br>
                    <span className="home-text163">Producer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide10 banner">
                  <span className="home-text166">
                    ...
                    <span className="home-text168">MEMA.</span>
                    <br className="home-text169"></br>
                    <span className="home-text170">&apos;Leve Escuro</span>
                    <span className="home-text171">&apos;</span>
                    <br className="home-text172"></br>
                    <span className="home-text173">Album</span>
                    <br className="home-text174"></br>
                    <br className="home-text175"></br>
                    <span className="home-text176">Mix Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide11 banner">
                  ...
                  <span className="home-text179">
                    ...
                    <span className="home-text181">Unknown Brain ft.</span>
                    <br className="home-text182"></br>
                    <span className="home-text183">Luke Burr</span>
                ...
                <div data-role="current-banner" className="home-slide12 banner">
                  <span className="home-text191">
                    ...
                    <span className="home-text193">MEMA.</span>
                    <br className="home-text194"></br>
                    <span className="home-text195">&apos;Estou Bem&apos;</span>
                    <br className="home-text196"></br>
                    <br className="home-text197"></br>
                    <span className="home-text198">Mix Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide13 banner">
                  <span className="home-text201">
                    ...
                    <span className="home-text203">Jubilee ft. IQ</span>
                    ...
                    <span className="home-text208">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide14 banner">
                  ...
                  <span className="home-text211">
                    ...
                    <span className="home-text213">Sandunes</span>
                    ...
                    <span className="home-text218">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
              ...
              <div className="home-slider-track1 blaze-track">
                <div data-role="current-banner" className="home-slide15 banner">
                  <span className="home-text221">
                    ...
                    <span className="home-text223">Vivi Thill</span>
                    ...
                    <span className="home-text227">of a songwriter&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide16 banner">
                  ...
                  <span className="home-text233">
                    ...
                    <span className="home-text235">Kota Banks</span>
                    ...
                    <span className="home-text240">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
                <div data-role="current-banner" className="home-slide17 banner">
                  <span className="home-text243">
                    ...
                    <span className="home-text245">MEMA.</span>
                    <br className="home-text246"></br>
                    <span className="home-text247">&apos;Estou Bem&apos;</span>
                    <br className="home-text248"></br>
                    <br className="home-text249"></br>
                    <span className="home-text250">Mix Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide18 banner">
                  <span className="home-text253"></span>
                  <img
                    alt="image"
                    src="https://freight.cargo.site/w/600/q/75/i/01d4d8ebb25c394ba53de81eef6ff759c150f1c801ebf8df5f677f7d1be4ae6a/fullacurve.jpg"
                ...
                <div data-role="current-banner" className="home-slide19 banner">
                  ...
                  <span className="home-text254">
                    ...
                    <span className="home-text256">Sandunes</span>
                    ...
                    <span className="home-text261">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
    ...
    transitionDuration: 0,
        ...
        <div className="home-container09">
          <div className="home-container10">
            ...
            <h1 className="home-heading2">
              <span className="home-text264">LISTEN</span>
              <br></br>
            </h1>
          </div>
        </div>
          ...
          <div id="whatido" className="home-container15">
            <div className="home-container16">
              ...
              <h1 className="home-heading3">
                <span className="home-text267">WHAT I DO</span>
          ...
          <div className="home-container18">
            <div className="home-container19">
              <span className="home-text269">
                <span className="home-text270">RECORDING</span>
                <br className="home-text271"></br>
                <span className="home-text272"> Vocal Tracking</span>
                <br className="home-text273"></br>
                <span className="home-text274"> Full band tracking</span>
                <br className="home-text275"></br>
                <span className="home-text276"> Live Sessions</span>
                <br className="home-text277"></br>
                <span className="home-text278">
                   Podcast, Voiceover &amp; Radio IDs
                </span>
                <br className="home-text279"></br>
                <span className="home-text280"> Broadcast for livestream</span>
                <br className="home-text281"></br>
                <br className="home-text282"></br>
                <span className="home-text283">SOFTWARE I USE</span>
                <br className="home-text284"></br>
                <span className="home-text285"> Pro Tools HD</span>
                <br className="home-text286"></br>
                <span className="home-text287"> Logic Pro X</span>
                <br className="home-text288"></br>
                <span className="home-text289"> </span>
                <span className="home-text290">UAD Console</span>
                <br className="home-text291"></br>
                <span className="home-text292"> Izotope RX</span>
                <br className="home-text293"></br>
                <span className="home-text294"> Fab Filter Pro</span>
                ...
                <span className="home-text298"> + more</span>
                <br className="home-text299"></br>
                <br className="home-text300"></br>
                <span className="home-text301">HARDWARE I USE</span>
                <br className="home-text302"></br>
                <span className="home-text303"> SSL4000G Series</span>
                <br className="home-text304"></br>
                <span className="home-text305"> SSL AWS 948</span>
                ...
                <span className="home-text317"> Ferrofish Converters</span>
                ...
                <span className="home-text321"> + more</span>
                <br className="home-text322"></br>
              </span>
            </div>
            <span className="home-text323">
              <span className="home-text324">MIXING</span>
              ...
              <span className="home-text330"> Vocal Tuning with Melodyne</span>
              ...
              <span className="home-text334"> Drum Editing</span>
              <br className="home-text335"></br>
              <span className="home-text336"> Podcast</span>
              <br className="home-text337"></br>
              <br className="home-text338"></br>
              <br className="home-text339"></br>
              <span className="home-text340">STUDIOS IVE WORKED FOR</span>
              ...
              <span className="home-text346"> Strongroom Studios London</span>
              <br className="home-text347"></br>
              <span className="home-text348"> Noatune Studios London</span>
              <br className="home-text349"></br>
              <br className="home-text350"></br>
              <span className="home-text351">AWARDS</span>
              ...
              <span className="home-text360">MASTERCLASSES</span>
              <br className="home-text361"></br>
              <span className="home-text362"> P</span>
              <span className="home-text363">
                op Beuro x SAE Electronic   Barcamp
              </span>
              <br className="home-text364"></br>
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="home-container20">
          <div className="home-container21">
            ...
            <h1 className="home-heading4">
              <span className="home-text365">WHAT I DO</span>
      ...
      <div className="home-blog">
        <h1 id="blog" className="home-heading5">
          ...
          <span className="home-text368">&gt;</span>
          <span className="home-text369">BLOG</span>
          <br></br>
        </h1>
      </div>
        ...
        <div className="home-content">
          <div className="home-container27">
            <span className="home-text371">
              <span className="home-text372">  RUBY SMITH</span>
              <br></br>
            ...
            <span className="home-text380">
              <span className="home-text381">For all enquiries:</span>
              <span>
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
      ...
      <div className="home-footer">
        <div className="home-content1">
          <div className="home-bottom">
            ...
            >
              <img alt="image" src="/arrow.svg" className="home-image23" />
            </a>
          </div>
        </div>
      </div>
