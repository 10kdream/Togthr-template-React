              ...
              <div className="home-slider-track blaze-track">
                ...
                <div data-role="current-banner" className="home-slide07 banner">
                  <span className="home-text129">
                    ...
                    <span className="home-text131">Freddie Dickson</span>
                    ...
                    <span className="home-text137">Recording Engineer</span>
                    <br className="home-text138"></br>
                    <span className="home-text139">Mix Engineer</span>
                    <br className="home-text140"></br>
                    <span className="home-text141">Producer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide08 banner">
                  <span className="home-text144">
                    ...
                    <span className="home-text146">MEMA.</span>
                    <br className="home-text147"></br>
                    <span className="home-text148">&apos;Leve Escuro</span>
                    <span className="home-text149">&apos;</span>
                    <br className="home-text150"></br>
                    <span className="home-text151">Album</span>
                ...
                <div data-role="current-banner" className="home-slide09 banner">
                  ...
                  <span className="home-text157">
                    ...
                    <span className="home-text159">Unknown Brain ft.</span>
                    <br className="home-text160"></br>
                    <span className="home-text161">Luke Burr</span>
                    ...
                    <span className="home-text166">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
                <div data-role="current-banner" className="home-slide10 banner">
                  <span className="home-text169">
                    ...
                    <span className="home-text171">MEMA.</span>
                    <br className="home-text172"></br>
                    <span className="home-text173">&apos;Estou Bem&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide11 banner">
                  <span className="home-text179">
                    ...
                    <span className="home-text181">Jubilee ft. IQ</span>
                ...
                <div data-role="current-banner" className="home-slide12 banner">
                  ...
                  <span className="home-text189">
                    ...
                    <span className="home-text191">Sandunes</span>
                    ...
                    <span className="home-text196">Recording Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                </div>
              ...
              <div className="home-slider-track1 blaze-track">
                <div data-role="current-banner" className="home-slide13 banner">
                  <span className="home-text199">
                    ...
                    <span className="home-text201">Vivi Thill</span>
                    ...
                    <span className="home-text205">of a songwriter&apos;</span>
                ...
                <div data-role="current-banner" className="home-slide14 banner">
                  ...
                  <span className="home-text211">
                    ...
                    <span className="home-text213">Kota Banks</span>
                ...
                <div data-role="current-banner" className="home-slide15 banner">
                  <span className="home-text221">
                    ...
                    <span className="home-text223">MEMA.</span>
                    <br className="home-text224"></br>
                    <span className="home-text225">&apos;Estou Bem&apos;</span>
                    <br className="home-text226"></br>
                    <br className="home-text227"></br>
                    <span className="home-text228">Mix Engineer</span>
                    <br></br>
                    <br></br>
                  </span>
                  <img
                ...
                <div data-role="current-banner" className="home-slide16 banner">
                  <span className="home-text231"></span>
                  <img
                    alt="image"
                    src="https://freight.cargo.site/w/600/q/75/i/01d4d8ebb25c394ba53de81eef6ff759c150f1c801ebf8df5f677f7d1be4ae6a/fullacurve.jpg"
    ...
    transitionDuration: 0,
        ...
        <div className="home-container09">
          <div className="home-container10">
            ...
            <h1 className="home-heading2">
              <span className="home-text242">LISTEN</span>
              <br></br>
            </h1>
          </div>
        </div>
          ...
          <div id="whatido" className="home-container15">
            <div className="home-container16">
              ...
              <h1 className="home-heading3">
                <span className="home-text245">WHAT I DO</span>
          ...
          <div className="home-container18">
            <div className="home-container19">
              <span className="home-text247">
                <span className="home-text248">RECORDING</span>
                <br className="home-text249"></br>
                <span className="home-text250"> Vocal Tracking</span>
                <br className="home-text251"></br>
                <span className="home-text252"> Full band tracking</span>
                <br className="home-text253"></br>
                <span className="home-text254"> Live Sessions</span>
                <br className="home-text255"></br>
                <span className="home-text256">
                   Podcast, Voiceover &amp; Radio IDs
                </span>
                <br className="home-text257"></br>
                <span className="home-text258"> Broadcast for livestream</span>
                <br className="home-text259"></br>
                <br className="home-text260"></br>
                <span className="home-text261">SOFTWARE I USE</span>
                <br className="home-text262"></br>
                <span className="home-text263"> Pro Tools HD</span>
                <br className="home-text264"></br>
                <span className="home-text265"> Logic Pro X</span>
                <br className="home-text266"></br>
                <span className="home-text267"> </span>
                <span className="home-text268">UAD Console</span>
                <br className="home-text269"></br>
                <span className="home-text270"> Izotope RX</span>
                <br className="home-text271"></br>
                <span className="home-text272"> Fab Filter Pro</span>
                ...
                <span className="home-text276"> + more</span>
                <br className="home-text277"></br>
                <br className="home-text278"></br>
                <span className="home-text279">HARDWARE I USE</span>
                <br className="home-text280"></br>
                <span className="home-text281"> SSL4000G Series</span>
                <br className="home-text282"></br>
                <span className="home-text283"> SSL AWS 948</span>
                ...
                <span className="home-text295"> Ferrofish Converters</span>
                ...
                <span className="home-text299"> + more</span>
                <br className="home-text300"></br>
              </span>
            </div>
            <span className="home-text301">
              <span className="home-text302">MIXING</span>
              ...
              <span className="home-text308"> Vocal Tuning with Melodyne</span>
              ...
              <span className="home-text312"> Drum Editing</span>
              <br className="home-text313"></br>
              <span className="home-text314"> Podcast</span>
              <br className="home-text315"></br>
              <br className="home-text316"></br>
              <br className="home-text317"></br>
              <span className="home-text318">STUDIOS IVE WORKED FOR</span>
              ...
              <span className="home-text324"> Strongroom Studios London</span>
              <br className="home-text325"></br>
              <span className="home-text326"> Noatune Studios London</span>
              <br className="home-text327"></br>
              <br className="home-text328"></br>
              <span className="home-text329">AWARDS</span>
              ...
              <span className="home-text338">MASTERCLASSES</span>
              <br className="home-text339"></br>
              <span className="home-text340"> P</span>
        ...
        <div className="home-container20">
          <div className="home-container21">
            ...
            <h1 className="home-heading4">
              <span className="home-text343">WHAT I DO</span>
      ...
      <div className="home-blog">
        <h1 id="blog" className="home-heading5">
          ...
          <span className="home-text346">&gt;</span>
          <span className="home-text347">BLOG</span>
          <br></br>
        </h1>
      </div>
        ...
        <div className="home-content">
          <div className="home-container27">
            <span className="home-text349">
              <span className="home-text350">  RUBY SMITH</span>
              <br></br>
            ...
            <span className="home-text358">
              <span className="home-text359">For all enquiries:</span>
              <span>
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
